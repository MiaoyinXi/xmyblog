  ...
  var transformColumns = React.useCallback(function (columns) {
    ...
    if (selectionType === 'radio') {
      renderCell = function renderCell(_, record, index) {
        var key = getRowKey(record, index);
        return /*#__PURE__*/React.createElement(_radio["default"], _extends({}, checkboxPropsMap.get(key), {
      ...
      renderCell = function renderCell(_, record, index) {
        ...
        return /*#__PURE__*/React.createElement(_checkbox["default"], _extends({}, checkboxPropsMap.get(key), {
          checked: hasKey,
